...
const _getBoundActionBindingParameter = req => {
  ...
  return (
    (req.target.actions &&
      req.target.actions[action] &&
      req.target.actions[action]['@cds.odata.bindingparameter.name']) ||
    'in' // > 'in' is the default binding parameter name for bound actions/functions
  )
}
