...
export class Service extends QueryAPI {
	...
	// Messaging API
	emit (eve: Events, data?: object, headers?: object) : Promise<this>

	// Http API
	send (eve: Events, entity: Target, data?: object, headers?: object) : Promise<this>
	send (eve: Events, data?: object, headers?: object) : Promise<this>
