...
class MigrationTableModel {
   ...
   * <code>extension.merge(base)</code>
   * 
   *    A---B---E---F extension
   *   / 
   *  A---B---C       base
   ...
   *  A---B---C           base
   *       
   * @param {MigrationTableModel} base The migration table file from which all missing migration versions 
   * will be merged into this migration table file.
