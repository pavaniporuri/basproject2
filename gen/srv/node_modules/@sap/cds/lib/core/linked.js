const _builtin = require('./csn').types, { any, struct, array, context, service, entity, annotation } = _builtin
const _kinds = { annotation, context, service, entity, view:entity }
const _reflect = require('./reflect'), {set} = _reflect
const _is_linked = Symbol ('is linked')

module.exports = function cds_linked (m) {
	const rm = _reflect(m,1)
	if (!rm[_is_linked]) {
