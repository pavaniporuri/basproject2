...
declare type FromJsonType<JsonT> = {
    ...
    [P in keyof JsonT]?: JsonT[P] extends (infer U)[] ? U extends Record<string, any> ? FromJsonType<U>[] : JsonT[P] : JsonT[P] extends Record<string, any> ? FromJsonType<JsonT[P]> : JsonT[P];
};
/**
 * @hidden
 */
