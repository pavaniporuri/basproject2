...
ASSERT_RANGE=Value is not in specified range
ASSERT_FORMAT=Value is not in specified format
ASSERT_DATA_TYPE=Value is invalid according to type definition
ASSERT_ENUM=Value is invalid according to enum declaration
