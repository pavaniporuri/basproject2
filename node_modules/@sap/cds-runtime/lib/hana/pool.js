      ...
      new Promise((resolve, reject) => {
        credentials4(tenant, credentials)
          .then(creds => {
            ...
            const INVALID_CREDENTIALS_WARNING = `Could not establish connection for tenant "${tenant}" due to invalid credentials. Existing pool will be drained.`
